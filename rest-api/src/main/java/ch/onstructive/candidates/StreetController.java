...
public class StreetController {
    ...
    public StreetController(StreetControllerMapper streetControllerMapper, StreetService streetService, PostalCodeController postalCodeController, AddressService addressService) {
    ...
    public HttpStatus create(@Valid @Body StreetPostModel model) {
        ...
        PostalCodeDTO postalCodeDTO = this.addressService.find(postalCodeId).orElseThrow(() -> new NotFoundException(postalCodeId, "postalCode"));
    ...
    public StreetGetModel updateStreet(@Valid @Body StreetPutModel model) {
        return streetService
            .find(model.getId())
            .map(fetched -> {
                PostalCodeDTO postalCode = this.addressService.find(model.getPostalCodeId()).orElseThrow(() -> new NotFoundException(model.getPostalCodeId(), "postalCode"));
