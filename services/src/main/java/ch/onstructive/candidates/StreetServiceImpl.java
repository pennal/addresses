...
public class StreetServiceImpl implements StreetService {
    ...
    public StreetServiceImpl(StreetRepository streetRepository, StreetServiceMapper streetServiceMapper, AddressServiceMapper addressServiceMapper) {
    ...
    public StreetDTO update(StreetDTO current, StreetDTO updated) {
        ...
        streetRepository.update(currentStreet.getId(), updatedStreet.getName(), updatedStreet.getHouseNumber(), updatedStreet.getPostalCode().getId());
